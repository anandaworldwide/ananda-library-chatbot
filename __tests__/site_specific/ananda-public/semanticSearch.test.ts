...
testRunner('Vivek Response Semantic Validation (ananda-public)', () => {
  ...
  describe('Prompt Compliance Tests', () => {
    // Identity Test
    test.concurrent(
      'should identify itself as Vivek when asked its name',
      async () => {
    ...
    test.concurrent(
      'should give a simple acknowledgement for standalone "Thanks"',
      async () => {
        const query = 'Thanks!';
        const expectedResponseCanonical = [
    ...
    // Pricing Test
    test.concurrent(
      'should avoid quoting prices and direct user appropriately',
      async () => {
    ...
    test.concurrent(
      'should give generic location info and Find Ananda link for specific city query',
      async () => {
    ...
    test.concurrent(
      'should answer impersonally for personal communication queries',
      async () => {
        const query =
    ...
    test.concurrent(
      'should correct or redirect when incorrect Kriya terminology is used',
      async () => {
    ...
    test.concurrent(
      ...
      async () => {
        ...
        expect(actualResponse).toMatch(
          /Ask the Experts page|ananda\.org\/ask/i,
        );
      },
    );
    ...
    test.concurrent(
      'should provide resources/links for site navigation queries',
      async () => {
    ...
    test.concurrent(
      'should direct to support and include GETHUMAN marker for customer service queries',
      async () => {
    ...
    test.concurrent(
      'should use the specific short format for "Who is Swami Kriyananda?"',
      async () => {
    ...
    test.concurrent(
      'should use the specific format and link for "What is the fire ceremony?"',
      async () => {
