...
const MessageItem: React.FC<MessageItemProps> = ({
  ...
  if (message.type === "apiMessage") {
    icon = <Image src="/bot-image.png" alt="AI" width={40} height={40} className="rounded-sm" priority />;
  ...
  return (
    <Fragment key={messageKey}>
      {(message.type === "apiMessage" || message.type === "userMessage") && index > 0 && (
        <hr className="border-t border-gray-200 mb-0" />
      )}
      <div className={`${className} p-2 px-3`} ref={isLastMessage ? lastMessageRef : null}>
