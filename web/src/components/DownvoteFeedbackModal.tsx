...
const DownvoteFeedbackModal: React.FC<DownvoteFeedbackModalProps> = ({ isOpen, docId, onConfirm, onCancel, error }) => {
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            ...
            className={`px-4 py-2 text-white rounded ${
              !selectedReason ? "bg-indigo-300 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700"
            }`}
          >
            Submit Feedback
          </button>
