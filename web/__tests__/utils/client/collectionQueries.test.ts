...
describe("collectionQueries", () => {
  beforeEach(async () => {
    ...
    // Default fetch mock implementation - ensure it's properly mocked
  ...
  describe("loadQueries", () => {
    ...
    it("should fetch different collections separately", async () => {
      ...
      expect(mockFetch).toHaveBeenNthCalledWith(2, "/data/site/collection2_queries.txt");
    });
    ...
    it("should fetch different sites separately", async () => {
      ...
      expect(mockFetch).toHaveBeenNthCalledWith(2, "/data/site2/collection_queries.txt");
    });
  });
  ...
  describe("getCollectionQueries", () => {
    it("should load queries for all collections in config", async () => {
      ...
      expect(mockFetch).toHaveBeenNthCalledWith(2, "/data/test-site/collection2_queries.txt");
